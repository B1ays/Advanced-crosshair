...
public val Icons.SettingsSliders: ImageVector
    get() {
        if (`_settings-sliders` != null) {
            return `_settings-sliders`!!
        }
        `_settings-sliders` = Builder(name = "Settings-sliders", defaultWidth = 512.0.dp,
...
private var `_settings-sliders`: ImageVector? = null
