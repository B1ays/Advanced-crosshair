...
public val Icons.`Palette-empty`: ImageVector
    get() {
        if (`_palette-empty` != null) {
            return `_palette-empty`!!
        }
        `_palette-empty` = Builder(name = "Palette-empty", defaultWidth = 512.0.dp, defaultHeight =
...
private var `_palette-empty`: ImageVector? = null
